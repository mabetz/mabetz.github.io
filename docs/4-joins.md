<a id="joins-and-other-ways-to-combining-or-create-tables"></a>
...
<img src="sql-join-types.png" width="592" height="300" alt="JOINS" />

Figure 1. 4 types of SQL `JOINS`
<a id="_additional_ways_to_combine_or_create_tables"></a>
...
<a id="_primary_and_foreign_keys"></a>
...
crew members who do not have a matching record in the `people` table.
...
Let us practise 'GROUP BY' and 'HAVING' with 'JOIN' by finding the
average rating of movies by year and genre, but only for the movies with
an average rating is greater than a certain amount.
...
4.6. WriteJOIN command to combine the `Batting` table with the `People`
